...
namesofvar <- data.frame(names = c("beg_hw_min", "dau_hw_min", "stunde", "Schulart", "Klassenstufe", "lh_ank", "lh_auf", "lh_nen", 
                                   "lh_sch", "lh_erl", "lh_wfr", "lh_bfr", "lh_wno", "lh_ano", "sh_auf", "sh_mel", "sh_fra", "sh_not"), 
                         labels = c("Beginn der Hausaufgabenvergabe in Minuten nach geplantem Stundenbeginn",
                                    "Dauer der Hausaufgabenvergabe in Minuten",
                                    "Länge der Unterrichtsstunde in Minuten",
                                    "Schulart [Grundschule/ Gymnasium]",
                                    "Klassenstufe [1 bis 12]",
                                    "L kündigt HA-Stellung an (verbal) [ja/nein]",
                                    "L verlangt Aufmerksamkeit (verbal/nonverbal) [ja/nein]",
                                    "L nennt HA [ja/nein]",
                                    "L schreibt HA an die Tafel [ja/nein]",
                                    "L erläutert Hausaufgabe / lässt erläutern [ja/nein]",
                                    "L fordert zu Fragen auf [ja/nein]",
                                    "L beantwortet Fragen: Wie viele werden beantwortet? [Wie viele?]",
                                    "L fordert zum Notieren auf [ja/nein]",
                                    "L achtet darauf, dass die HA notiert werden [ja/nein]",
                                    "S sind aufmerksam [trifft zu, trifft eher zu, trifft teils-teils zu, trifft eher nicht zu, trifft nicht zu]",
                                    "S melden sich, um zu fragen: Wie viele Meldungen? [Wie viele?]",
                                    "S fragen mit oder ohne Meldung: Wie viele Fragen werden tatsächlich gestellt? [Wie viele?]",
                                    "S notieren HA: Wie viele S ungefähr in % geschätzt? [Wie viele?]"))
...
```{r korrelationen plot, fig.width=11, fig.height=11}
...
```{r korrelation dauer - zeitpunkt 1}
...
```{r korrelation dauer - zeitpunkt 2}
